...
(function(){
  ...
  var SHELL=" \uac00 \uc544\ub2c8\ub77c #body div \uc5d0 \ubd99\ub294\ub2e4 (`stamping` \ub9cc document.body \ub2e4).\n   `body.lifting` \ub85c \uc4f0\uba74 \uc870\uc6a9\ud788 \uc544\ubb34\uac83\ub3c4 \uc548 \uac78\ub9b0\ub2e4 \u2014 \uc2e4\uc81c\ub85c \ud55c \ubc88 \uadf8\ub807\uac8c \uc37c\ub2e4 */\n.body.lifting #feed.view-board .pc:not(.lift){\n  transition:transform .3s cubic-bezier(.2,.9,.3,1.14),border-color .2s ease,\n             left .19s cubic-bezier(.22,1,.36,1),top .19s cubic-bezier(.22,1,.36,1)}\n.body.lifting #feed.view-board .pc.yield{border-color:rgba(236,48,19,.55)}\n.grip{position:absolute;top:1px;left:50%;transform:translateX(-50%);padding:5px 18px;cursor:grab;color:var(--ink);opacity:.3;font-size:9px;letter-spacing:3px;user-select:none;transition:.18s;display:none}\n#feed.view-board .grip{display:block}\n#feed.view-board .pc:hover .grip{opacity:.9;color:var(--red)}\n.rz{position:absolute;right:0;bottom:0;width:38px;height:38px;cursor:nwse-resize;display:none;align-items:flex-end;justify-content:flex-end;padding:4px;touch-action:none;z-index:6}\n#feed.view-board .rz{display:flex}\n.rz::after{content:'';width:12px;height:12px;border-right:3px solid var(--red);border-bottom:3px solid var(--red);opacity:.45;transition:.18s}\n#feed.view-board .pc:hover .rz::after{opacity:1}\n.badge{position:absolute;top:3px;right:3px;background:var(--ink);color:#fff;font-weight:800;font-size:10px;letter-spacing:.04em;padding:3px 6px;z-index:7;pointer-events:none;display:none}\n#feed.view-board .pc.lift .badge,#feed.view-board .pc.rzing .badge{display:block}\n#ghost{position:absolute;border:2px dashed rgba(236,48,19,.6);background:rgba(236,48,19,.05);display:none;pointer-events:none;z-index:800;transition:left .12s linear,top .12s linear}\n#ghost.on{display:block}\n#ghost::after{content:'HERE';position:absolute;left:50%;top:50%;transform:translate(-50%,-50%);font-weight:800;font-size:9.5px;letter-spacing:.16em;color:var(--red-700)}\n\n/* \u2550\u2550\u2550 \uad6c\uc5ed(Zone) \u2014 \ud050 5 \u2550\u2550\u2550\n   \uad6c\uc5ed\uc740 **\uac00\ub85c \ubc34\ub4dc**\ub2e4. \uc138\ub85c \ub808\uc778\uc774 \uc544\ub2c8\ub2e4 \u2014 390px \ubcf4\ub4dc \uc548\ud3ed\uc774 310px \uc778\ub370 \uce74\ub4dc\uac00 316px \uc774\ub77c\n   \ub808\uc778\uc73c\ub85c \ub098\ub204\uba74 \uce74\ub4dc\uac00 \uc6d0\ub9ac\uc801\uc73c\ub85c \uc548 \ub4e4\uc5b4\uac04\ub2e4. \ubc34\ub4dc\ub97c \uc138\ub85c\ub85c \uc313\uc73c\uba74 1\uceec\ub7fc \ud654\uba74\uc5d0\uc11c\n   \uadf8\ub300\ub85c \"\uc138\ub85c \uc2a4\ud0dd\"\uc774 \ub418\uc5b4 \ud050\uac00 \uc694\uad6c\ud55c \ubaa8\ubc14\uc77c \ub3d9\uc791\uc774 \uacf5\uc9dc\ub85c \ub098\uc628\ub2e4.\n\n   \ud5e4\ub354\ub294 \ud53c\ub4dc\uc758 `.seclbl`(\ub77c\ubca8 + 2px \ub8f0)\uc744 \ubcf4\ub4dc\ub85c \uc62e\uae34 \uac83\uc774\ub2e4. \ub192\uc774 44px \uc740 \ub450 \uac00\uc9c0\ub97c \ub3d9\uc2dc\uc5d0 \ub9cc\uc871\ud55c\ub2e4 \u2014\n   GRID(22)\uc758 \ubc30\uc218\ub77c \uce74\ub4dc y \uc2a4\ub0c5\uc774 \uae68\uc9c0\uc9c0 \uc54a\uace0, \uc811\uae30 \ubc84\ud2bc\uc758 \ud130\uce58 \ud0c0\uae43 44px \ub3c4 \ub41c\ub2e4.\n\n   \ubc34\ub4dc\ub294 `pointer-events:none` \uc774\uace0 \uce74\ub4dc\ubcf4\ub2e4 **\uc55e\ucabd DOM** \uc774\ub77c \ud56d\uc0c1 \uce74\ub4dc \ubc11\uc5d0 \uae54\ub9b0\ub2e4.\n   \ud5e4\ub354\ub9cc `auto` \ub85c \ub418\uc0b4\ub9b0\ub2e4 \u2014 \uce74\ub4dc\ub294 \ud5e4\ub354 \uc544\ub798(top+44)\ubd80\ud130 \ub193\uc774\ubbc0\ub85c \uc11c\ub85c \uac00\ub9ac\uc9c0 \uc54a\ub294\ub2e4. */\n#feed.view-board .zband{position:absolute;left:0;right:0;pointer-events:none}\n#feed.view-board .zband .zhead{position:absolute;left:0;right:0;top:0;height:44px;\n  display:flex;align-items:center;gap:9px;pointer-events:auto;cursor:pointer;\n  border:none;background:transparent;padding:0;text-align:left;color:var(--red-700);font-family:inherit}\n.zhead .zt{font-weight:800;font-size:10px;letter-spacing:.18em;text-transform:uppercase}\n.zhead .zn{font-weight:800;font-size:9.5px;letter-spacing:.1em;color:var(--ink);opacity:.45}\n.zhead .zr{flex:1;height:2px;background:var(--ink);opacity:.16}   /* \ube0c\ub79c\ub4dc \ub8f0 \u2014 2px ink */\n/* \uce90\ub7ff\uc740 CSS \uc0bc\uac01\ud615\uc774\ub2e4. radius 0 \uaddc\uce59\uacfc \ucda9\ub3cc\ud558\uc9c0 \uc54a\uace0 \uc0c9\uc774 currentColor \ub97c \ub530\ub77c\uac04\ub2e4 */\n.zhead .zcar{flex:none;width:0;height:0;border-left:6px solid currentColor;\n  border-top:4.5px solid transparent;border-bottom:4.5px solid transparent;\n  transform:rotate(90deg);transition:transform .18s ease}\n.zband.fold .zhead .zcar{transform:rotate(0deg)}\n.zhead:hover .zt{color:var(--red)}\n.zhead:hover .zr{opacity:.3}\n/* \ube48 \uad6c\uc5ed\uc5d0 \ud45c\uc801\uc774 \uc5c6\uc73c\uba74 **\uc601\uc6d0\ud788 \ucc44\uc6b8 \uc218 \uc5c6\ub2e4** \u2014 \ub04c\uc5b4 \ub123\uc744 \uba74\uc774 0px \uc774\uae30 \ub54c\ubb38 */\n#feed.view-board .zband .zdrop{position:absolute;left:0;right:0;top:44px;bottom:0;\n  border:2px dashed rgba(32,30,29,.18);display:flex;align-items:center;padding:0 13px;\n  font-weight:800;font-size:10px;letter-spacing:.16em;text-transform:uppercase;opacity:.45}\n/* \ub04c\uace0 \uc788\ub294 \ub3d9\uc548 \"\uc5b4\ub290 \uad6c\uc5ed\uc5d0 \ub4e4\uc5b4\uac00\ub294\uc9c0\"\ub97c \uc54c\ub9b0\ub2e4.\n   \uc790\ub3d9 \uc815\ub82c\uc774\ub77c \uc704\uce58\ub97c \uc608\uace0\ud558\ub294 #ghost \ub294 \uac70\uc9d3\ub9d0\uc774 \ub41c\ub2e4 \u2014 \uadf8\ub798\uc11c \uad6c\uc5ed \ubaa8\ub4dc\uc5d0\uc11c\ub294 \uace0\uc2a4\ud2b8\ub97c \ub048\ub2e4 */\n#feed.view-board .zband.over .zr{background:var(--red);opacity:1}\n#feed.view-board .zband.over .zt{color:var(--red)}\n#feed.view-board .zband.over .zdrop{border-color:var(--red);opacity:.9;color:var(--red-700)}\n#feed.view-board .zband.over::after{content:'';position:absolute;left:0;right:0;top:44px;bottom:0;\n  background:rgba(236,48,19,.06)}\n\n/* \u2550\u2550\u2550 \ub3c4\uc7a5(Stamp) \u2014 \ud050 4 \u2550\u2550\u2550\n   FigJam \uadfc\uac70: \ub3c4\uad6c\ub97c \ucf1c\uba74 \ucf1c\uc9c4 \ucc44\ub85c \ub0a8\uc544 \uc5f0\uc18d\uc73c\ub85c \ucc0d\uace0, **\ub3c4\uc7a5\uc774 \uac1d\uccb4\uc5d0 \ubd99\uc5b4 \ud568\uaed8 \uc6c0\uc9c1\uc778\ub2e4.**\n   \uadf8\ub798\uc11c \ub3c4\uc7a5\uc740 DOM \uc7a5\uc2dd\uc774 \uc544\ub2c8\ub77c `d.stamps[]` \ub370\uc774\ud130\ub2e4 \u2014 \ubdf0 \uc804\ud658\u00b7\ud544\ud130\u00b7\uc815\ub82c\u00b7\ub9ac\uc0ac\uc774\uc988\uc5d0 \uc0b4\uc544\ub0a8\ub294\ub2e4.\n\n   **`.rstlayer` \uc5d0 z-index \ub97c \uc8fc\uc9c0 \ub9c8\ub77c.** z-index \uac00 \ubd99\uc73c\uba74 \uc313\uc784 \ubb38\ub9e5\uc774 \uc0dd\uaca8\n   `mix-blend-mode:multiply` \uac00 \uadf8 \uc548\uc5d0\uc11c \uaca9\ub9ac\ub418\uace0, \uc789\ud06c\uac00 \uce74\ub4dc \ubc30\uacbd\uacfc \uc11e\uc774\uc9c0 \uc54a\uc544 \uc9c8\uac10\uc774 \uc8fd\ub294\ub2e4.\n   \uc704\uce58\ub9cc \uc7a1\uace0 DOM \uc21c\uc11c(\ub9c8\uc9c0\ub9c9 \uc790\uc2dd)\ub85c \uc704\uc5d0 \uc62c\ub9b0\ub2e4. \ud540(z5)\u00b7\ub9ac\uc0ac\uc774\uc988(z6) \ubc11\uc5d0 \uae54\ub9ac\ub294 \uac74 \uc758\ub3c4\ud55c \uac83\uc774\ub2e4 \u2014\n   \uc2e4\uc81c \ub3c4\uc7a5\ub3c4 \uc555\uc815 \ubc11\uc73c\ub85c \uc9c0\ub098\uac04\ub2e4. */\n.rstlayer{position:absolute;inset:0;pointer-events:none;overflow:hidden}\n.rstmp{position:absolute;left:var(--x);top:var(--y);transform:translate(-50%,-50%) rotate(var(--rot));\n  border:2px solid currentColor;padding:5px 8px 4px;font-weight:900;font-size:11px;line-height:1;\n  letter-spacing:.13em;text-transform:uppercase;white-space:nowrap;\n  color:var(--red);opacity:.82;mix-blend-mode:multiply;filter:url(#inkedge)}\n/* \uc2e4\uc81c \uace0\ubb34\ub3c4\uc7a5\uc740 \ud14c\ub450\ub9ac\uac00 \ub450 \uacb9\uc774\ub2e4. 2px \ub8f0\uc740 \ubc14\uae65 \ud14c\ub450\ub9ac\uac00 \uc9c0\ud0a8\ub2e4 */\n.rstmp::after{content:'';position:absolute;inset:2px;border:1px solid currentColor;opacity:.5}\n/* \ucc0d\ud788\ub294 \uc21c\uac04 \u2014 \uc704\uc5d0\uc11c \ub20c\ub7ec \ucc0d\ub294 \ubaa8\uc158. \uc0c8\ub85c \ub193\uc778 \ub3c4\uc7a5\uc5d0\ub9cc \ubd99\uc778\ub2e4(\uc804\uccb4 \uc7ac\ub80c\ub354\uc5d0\uc11c\ub294 \uc548 \ubd99\ub294\ub2e4) */\n.rstmp.fresh{animation:inkpress .3s cubic-bezier(.2,.85,.3,1.4)}\n@keyframes inkpress{\n  /* **opacity \ub97c \uac74\ub4dc\ub9ac\uc9c0 \uc54a\ub294\ub2e4.** 0% \ub97c opacity:0 \uc73c\ub85c \ub450\uba74 \uc560\ub2c8\uba54\uc774\uc158\uc774 \uc2dc\uc791\ub418\uc9c0 \uc54a\uac70\ub098 \uc911\uac04\uc5d0 \uba48\ucd98\n     \ud658\uacbd\uc5d0\uc11c \ub3c4\uc7a5\uc774 \uc544\uc608 \ubcf4\uc774\uc9c0 \uc54a\ub294\ub2e4 (\uc2e4\uce21: \ud558\ub124\uc2a4 \ucc3d\uc774 \uc228\uaca8\uc838 \ud504\ub808\uc784\uc774 \uc548 \ub3cc\uc790 opacity 0 \u00b7 scale 1.58 \uc5d0\uc11c \uad73\uc5c8\ub2e4).\n     \ubcf4\uc774\ub294\uc9c0 \uc5ec\ubd80\uac00 \uc560\ub2c8\uba54\uc774\uc158\uc5d0 \uc758\uc874\ud558\uba74 \uc548 \ub41c\ub2e4 \u2014 scale \ub9cc \ud754\ub4e4\uba74 \ucd5c\uc545\uc758 \uacbd\uc6b0\uc5d0\ub3c4 \uc0ac\ub77c\uc9c0\uc9c0\ub294 \uc54a\ub294\ub2e4. */\n  0%{transform:translate(-50%,-50%) rotate(var(--rot)) scale(1.6)}\n  55%{transform:translate(-50%,-50%) rotate(var(--rot)) scale(.96)}\n  100%{transform:translate(-50%,-50%) rotate(var(--rot)) scale(1)}}\n\n/* \ubb34\uc7a5 \ubaa8\ub4dc \u2014 \uce74\ub4dc \uc804\uccb4\uac00 \ucc0d\ub294 \uba74\uc774 \ub41c\ub2e4.\n   \ucee8\ud2b8\ub864\uc744 \uc8fd\uc774\ub294 \uac8c \ud575\uc2ec\uc774\ub2e4: \ub3c4\uc7a5\uc744 \ucc0d\uc73c\ub824\ub2e4 \u2665\u00b7\uc0ad\uc81c\u00b7\ub4dc\ub798\uadf8\uac00 \uac78\ub9ac\ub294 \uc0ac\uace0\ub97c **\uc6d0\ub9ac\uc801\uc73c\ub85c** \uc5c6\uc564\ub2e4.\n   (JS \ucabd\uc5d0\ub3c4 \ub4dc\ub798\uadf8 \uac00\ub4dc\uac00 \uc788\ub2e4 \u2014 `.grip` \uc740 \uc5ec\uae30\uc11c \uc8fd\uc9c0\ub9cc \uce74\ub4dc \ubcf8\uccb4 pointerdown \uc740 CSS \ub85c \ubabb \ub9c9\ub294\ub2e4) */\nbody.stamping #feed .pc{cursor:crosshair}\nbody.stamping #feed .pc:hover{border-color:var(--red)}\nbody.stamping #feed .pc .foot,\nbody.stamping #feed .pc .poll,\nbody.stamping #feed .pc .cmt,   /* \ud050 11 \u2014 \ub3c4\uc7a5 \ucc0d\uc73c\ub824\ub2e4 \ub313\uae00 \uc785\ub825\uc5d0 \ud3ec\ucee4\uc2a4\uac00 \uac00\uba74 \uc548 \ub41c\ub2e4 */\nbody.stamping #feed .pc .rxw,   /* \ud050 12 \u2014 `+N more` \ub3c4 \ub9c8\ucc2c\uac00\uc9c0. \u2665 \uc790\uccb4\ub294 `.foot` \uc548\uc774\ub77c \uc704\uc5d0\uc11c \uc774\ubbf8 \uc8fd\ub294\ub2e4 */\nbody.stamping #feed .pc .pin,\nbody.stamping #feed .pc .rz,\nbody.stamping #feed .pc .grip{pointer-events:none}\nbody.stamping .fab{display:none}   /* \ud2b8\ub808\uc774\uc640 \uacb9\uce5c\ub2e4. \uc9c0\uae08\uc740 \uc4f0\ub294 \ubaa8\ub4dc\uac00 \uc544\ub2c8\ub77c \ucc0d\ub294 \ubaa8\ub4dc\ub2e4 */\n\n/* \ub3c4\uc7a5 \ud2b8\ub808\uc774 \u2014 `.body` \uc640 `.stat` \uc0ac\uc774\uc758 \ud750\ub984\uc5d0 \ub123\ub294\ub2e4.\n   \uacb9\uccd0 \uae54\uba74 \ub9e8 \uc544\ub798 \uce74\ub4dc\uac00 \uac00\ub824\uc9c4\ub2e4. \ud750\ub984\uc5d0 \ub123\uc73c\uba74 body \uac00 \uc904\uc5b4\ub4e4\uc5b4 \uc544\ubb34\uac83\ub3c4 \uac00\ub824\uc9c0\uc9c0 \uc54a\ub294\ub2e4 */\n.stray{display:none;flex:none;align-items:center;gap:8px;padding:8px 12px;border-top:2px solid var(--ink);background:var(--paper)}\n.stray.on{display:flex}\n.stray .l2{flex:none;font-weight:800;font-size:9.5px;letter-spacing:.16em;text-transform:uppercase;opacity:.5}\n.spick{display:flex;gap:6px;flex:1 1 0;min-width:0;overflow-x:auto;overflow-y:hidden;\n  scrollbar-width:none;-webkit-overflow-scrolling:touch}\n.spick::-webkit-scrollbar{display:none}\n.spick.scrollable{-webkit-mask-image:linear-gradient(90deg,#000 calc(100% - 16px),transparent);\n                          mask-image:linear-gradient(90deg,#000 calc(100% - 16px),transparent)}\n/* .on \uc5d0\uc11c \ud14c\ub450\ub9ac \ub450\uaed8\ub97c \ubc14\uafb8\uc9c0 \uc54a\ub294\ub2e4 \u2014 \ud3ed\uc774 \ubcc0\ud558\uba74 \uc2a4\ud2b8\ub9bd\uc774 1px \uc529 \uc6c0\ucc14\ud55c\ub2e4.\n   \uce69\uacfc \uac19\uc740 \ubc29\uc2dd(\ubc30\uacbd \ubc18\uc804)\uc73c\ub85c \ud45c\uc2dc\ud558\uace0, \uac01 \ub3c4\uc7a5\uc758 \uc0c9\uc744 --sc \ub85c \ubc1b\ub294\ub2e4 */\n.spick button{--sc:var(--ink);flex:none;min-height:44px;padding:0 12px;cursor:pointer;\n  border:1.5px solid var(--line);background:transparent;color:var(--ink);\n  font-weight:900;font-size:10.5px;letter-spacing:.1em;text-transform:uppercase;white-space:nowrap}\n.spick button:hover{border-color:var(--ink)}\n.spick button.on{background:var(--sc);border-color:var(--sc);color:#fff}\n.stray .sbtn{flex:none;min-width:44px;min-height:44px;padding:0 12px;cursor:pointer;\n  border:1.5px solid var(--ink);background:transparent;color:var(--ink);\n  font-weight:800;font-size:11px;letter-spacing:.1em;text-transform:uppercase}\n.stray .sbtn:hover{background:var(--ink);color:var(--paper)}\n.stray .sbtn:disabled{opacity:.3;cursor:not-allowed}\n.stray .sbtn:disabled:hover{background:transparent;color:var(--ink)}\n.stray .sbtn.go{background:var(--red);border-color:var(--red);color:#fff}\n.stray .sbtn.go:hover{background:var(--red-700);border-color:var(--red-700)}\n@media (max-width:860px){\n  .stray{padding:8px 10px;gap:6px}\n  .stray .l2{display:none}          /* \ud2b8\ub808\uc774 \uc790\uccb4\uac00 \ub77c\ubca8\uc774\ub2e4 */\n  .spick button{padding:0 10px}\n}\n\n/* \u2550\u2550\u2550 \ud22c\ud45c(Vote) \u2014 \ud050 6 \u2550\u2550\u2550\n   FigJam \uadfc\uac70: \ud22c\ud45c \uc911\uc5d0\ub294 \ucee4\uc11c\uae4c\uc9c0 \uc228\uaca8 \ud45c\uac00 \ub4dc\ub7ec\ub098\uc9c0 \uc54a\uace0, \uc138\uc158\uc774 \ub05d\ub098\uba74 \uacb0\uacfc\uac00 \ud55c \ubc88\uc5d0 \uacf5\uac1c\ub41c\ub2e4.\n   \u2192 \uc774 \uc571\uc5d0\uc11c\ub294 **per-option \uc9d1\uacc4\ub9cc** \uc228\uae34\ub2e4. \ucd1d \ucc38\uc5ec\uc218\ub294 \ubcf4\uc5ec\uc900\ub2e4 \u2014\n     \uc644\uc804 \uc740\ub2c9\uc774\uba74 \uc5b8\uc81c \ub9c8\uac10\ud574\uc57c \ud558\ub294\uc9c0 \uc54c \uc218 \uc5c6\uc5b4 \ud22c\ud45c\uac00 \uc601\uc6d0\ud788 \uc5f4\ub824 \uc788\uac8c \ub41c\ub2e4(\ucc44\uc810\ud45c \u00a7\ud22c\ud45c).\n\n   \ud5e4\ub354\ub294 `.seclbl`\u00b7`.zhead` \uc640 \uac19\uc740 \uc870\ub9bd\uc774\ub2e4: \ub77c\ubca8(red-700, .18em) + 2px ink \ub8f0.\n   \uc0c8 \uc2dc\uac01 \uc5b8\uc5b4\ub97c \ub9cc\ub4e4\uc9c0 \uc54a\ub294\ub2e4 \u2014 \uc774 \ud30c\uc77c\uc5d0\ub294 \uc774\ubbf8 \uac19\uc740 \uc5ed\ud560\uc758 \uba38\ub9ac\ud45c\uac00 \ub450 \uac1c \uc788\ub2e4.\n\n   \ub9c8\uac10 \ubc84\ud2bc\uc744 `.foot` \uc5d0 \ub123\uc9c0 \uc54a\ub294 \uc774\uc720: dense \ubcf4\ub4dc 228px \uc5d0\uc11c `.foot` \ub294 \uc774\ubbf8 4\ubc84\ud2bc\uc774\ub77c\n   5\ubc88\uc9f8\ub97c \ub123\uc73c\uba74 2\uc904\ub85c \ub118\uccd0 **\uce74\ub4dc \ub192\uc774\uac00 \ub294\ub2e4.** \ub3c4\uc7a5\u00b7\uad6c\uc5ed\uc5d0\uc11c \ub450 \ubc88 \uac19\uc740 \uc774\uc720\ub85c \uae30\uac01\ud55c \uc790\ub9ac\ub2e4. */\n/* \uc0ac\uc9c4 **\ub4a4\uc5d0** \ub193\ub294\ub2e4 \u2014 \uc0ac\uc9c4\uc774 \uc9c8\ubb38\uc758 \uadfc\uac70\uc778 \uacbd\uc6b0(\"\uc5b4\ub290 \ucabd\uc774 \ub098\uc544?\")\uac00 \uc790\uc5f0\uc2a4\ub7fd\uace0,\n   \uc870\uc791 \uc694\uc18c(\uc120\ud0dd\uc9c0\u00b7\ub9c8\uac10)\uac00 `.foot` \uacfc \ubd99\uc5b4 \uce74\ub4dc \uc544\ub798\ucabd\uc5d0 \ubaa8\uc778\ub2e4 */\n.pc .poll{margin-top:12px}\n.pc .phead{display:flex;align-items:center;gap:9px;margin-bottom:7px}\n.pc .phead .pl{flex:none;font-weight:800;font-size:10px;letter-spacing:.18em;text-transform:uppercase;color:var(--red-700)}\n.pc .phead .pn{flex:none;font-weight:800;font-size:9.5px;letter-spacing:.1em;text-transform:uppercase;opacity:.45}\n.pc .phead .pr{flex:1;height:2px;background:var(--ink);opacity:.16}\n.pc .popt{position:relative;display:flex;align-items:center;gap:9px;width:100%;min-height:40px;\n  border:1.5px solid var(--line);background:transparent;color:inherit;font-family:inherit;\n  padding:8px 10px;text-align:left;cursor:pointer;overflow:hidden}\n.pc .popt+.popt{margin-top:6px}\n.pc .popt:hover{border-color:var(--ink)}\n/* \ud45c\uc2dd\uc740 \uc0ac\uac01\ud615\uc774\ub2e4 \u2014 radius 0 \uaddc\uce59\uc774 \ub77c\ub514\uc624 \ubc84\ud2bc\uc5d0\ub3c4 \uadf8\ub300\ub85c \uc801\uc6a9\ub41c\ub2e4 */\n.pc .pmk{flex:none;width:13px;height:13px;border:2px solid currentColor;opacity:.4;z-index:1}\n.pc .popt.mine{border-color:var(--red)}\n.pc .popt.mine .pmk{background:var(--red);border-color:var(--red);opacity:1}\n.pc .pt{flex:1;min-width:0;font-size:13px;font-weight:600;line-height:1.35;word-break:break-word;z-index:1}\n.pc .pv{flex:none;font-weight:800;font-size:9.5px;letter-spacing:.08em;text-transform:uppercase;opacity:.55;z-index:1}\n.pc .popt.mine .pv{opacity:1;color:var(--red-700)}\n/* \uacb0\uacfc \ub9c9\ub300\ub294 \uae00\uc790 **\ub4a4\uc5d0** \uae50\ub2e4. \ud3ed\uc774 \uace7 \ube44\uc728\uc774\ub77c \uc22b\uc790\ub97c \uc77d\uc9c0 \uc54a\uc544\ub3c4 \uc21c\uc704\uac00 \ubcf4\uc778\ub2e4.\n   \ub9c9\ub300\ub97c \ubcc4\ub3c4 \uc904\ub85c \ub450\uba74 \uc120\ud0dd\uc9c0 \ud558\ub098\uac00 \ub450 \uc904\uc774 \ub418\uc5b4 228px \uce74\ub4dc\uc5d0\uc11c \ub192\uc774\uac00 \ub450 \ubc30\uac00 \ub41c\ub2e4 */\n.pc .pbar{position:absolute;left:0;top:0;bottom:0;width:var(--p,0%);background:rgba(32,30,29,.09);pointer-events:none}\n.pc .popt.win{border-color:var(--red)}\n.pc .popt.win .pbar{background:rgba(236,48,19,.15)}\n.pc .popt.win .pt{font-weight:900;color:var(--red-700)}\n.pc .pclose{display:block;width:100%;margin-top:7px;min-height:40px;padding:9px;cursor:pointer;\n  border:1.5px solid var(--ink);background:transparent;color:inherit;font-family:inherit;\n  font-weight:800;font-size:10px;letter-spacing:.12em;text-transform:uppercase}\n.pc .pclose:hover{background:var(--ink);color:var(--paper)}\n\n/* \u2550\u2550\u2550 \ub313\uae00(Comments) \u2014 \ud050 11 \u2550\u2550\u2550\n   FigJam \uadfc\uac70: \ub313\uae00\uc740 **\uac1d\uccb4\uc5d0 \ubd99\uace0 \uce94\ubc84\uc2a4\uc5d0\uc11c \ubc14\ub85c \ubcf4\uace0 \ub2f5\ud55c\ub2e4.** \uc0ac\uc774\ub4dc\ubc14\ub294 \uad00\ub9ac\uc6a9 \ubcf4\uc870\ub2e4.\n   \u2192 \uc5ec\uae30\uc11c\ub3c4 \uce74\ub4dc \uc548\uc5d0\uc11c \uc5f0\ub2e4. \ubaa8\ub2ec\ub85c \uc5f4\uba74 \ubcf4\ub4dc\uc5d0\uc11c \ub9e5\ub77d\uc774 \ub04a\uae34\ub2e4(\ud050\uac00 \uc9c1\uc811 \uae08\uc9c0).\n\n   **`.foot` \uc544\ub798**\uc5d0 \ub454\ub2e4. \uc704\uc5d0 \uc5f4\uba74 `.foot` \uc774 \ubc00\ub824 \ub0b4\ub824\uac00 **\ubc29\uae08 \ub204\ub978 \ubc84\ud2bc\uc774 \uc190\uac00\ub77d \ubc11\uc5d0\uc11c \ub3c4\ub9dd\uac04\ub2e4.**\n   \ud22c\ud45c\ub294 `.foot` \ubc16(\uc0ac\uc9c4 \ub4a4)\uc5d0\uc11c \uc5f4\ub9ac\ubbc0\ub85c \uac19\uc740 \ubb38\uc81c\uac00 \uc5c6\uc5c8\ub2e4 \u2014 \uadf8 \ubc30\uce58\ub97c \uadf8\ub300\ub85c \ubca0\ub07c\uba74 \uc548 \ub41c\ub2e4.\n\n   \uad6c\ud68d\uc740 \uc0c8 \ud45c\uba74\uc744 \ub9cc\ub4e4\uc9c0 \uc54a\uace0 **2px ink \ub8f0** \ud558\ub098\ub85c \ud55c\ub2e4 (`.phdr .r`\u00b7`.phead .pr` \uacfc \uac19\uc740 \uc870\ub9bd).\n   \ud589\uc740 flex \uac00 \uc544\ub2c8\ub77c **\uc778\ub77c\uc778 \ud750\ub984**\uc774\ub2e4 \u2014 \uc791\uc740 \ucabd\uc9c0(\uc548\ud3ed 154px)\uc5d0\uc11c flex 3\uce78\uc774\uba74 \uae00\uc790\uac00 \ud55c \uc790\uc529 \ub04a\uae34\ub2e4. */\n.pc .cmt{display:none;margin-top:10px;border-top:2px solid var(--ink);padding-top:8px}\n.pc .cmt.on{display:block}\n.pc .cmore{display:block;width:100%;min-height:32px;margin-bottom:4px;padding:7px 8px;cursor:pointer;\n  border:1.5px solid var(--line);background:transparent;color:inherit;font-family:inherit;\n  font-weight:800;font-size:9.5px;letter-spacing:.12em;text-transform:uppercase;opacity:.65}\n.pc .cmore:hover{opacity:1;border-color:var(--ink)}\n.pc .crow{padding:5px 0;font-size:13px;line-height:1.45;word-break:break-word}\n.pc .crow+.crow{border-top:1.5px solid var(--line-soft)}\n.pc .cwho{font-weight:800;font-size:9.5px;letter-spacing:.1em;text-transform:uppercase;color:var(--red-700);margin-right:6px}\n.pc .cwhen{font-weight:600;font-size:9px;letter-spacing:.1em;text-transform:uppercase;opacity:.4;margin-left:6px;white-space:nowrap}\n.pc .cadd{display:flex;gap:6px;margin-top:7px}\n.pc .cin{flex:1;min-width:0;min-height:36px;padding:8px 9px;font-family:inherit;font-size:13px;\n  border:1.5px solid var(--line);background:transparent;color:inherit;border-radius:0}\n.pc .cin:focus{outline:none;border-color:var(--ink)}\n.pc .csend{flex:none;min-height:36px;padding:0 12px;cursor:pointer;\n  border:1.5px solid var(--ink);background:transparent;color:inherit;font-family:inherit;\n  font-weight:800;font-size:10px;letter-spacing:.12em;text-transform:uppercase}\n.pc .csend:hover{background:var(--ink);color:var(--paper)}\n/* \uc5f4\ub9b0 \uc0c1\ud0dc\ub97c \ubc84\ud2bc\uc5d0 \ub0a8\uae34\ub2e4 \u2014 \uc811\ud78c \uc0c1\ud0dc\uac00 \uc548 \ubcf4\uc774\uba74 \uc548 \ub41c\ub2e4(\ud234\ubc14 `\u22ef` \ud65c\uc131 \uc810\uacfc \uac19\uc740 \uaddc\uce59) */\n.pc .act.open{opacity:1;color:var(--red-700)}\n\n/* \uc791\uc131 3\ub2e8\uc758 \ud22c\ud45c \ud3b8\uc9d1\uae30 \u2014 \uc548 \ucf1c\uba74 \ubc84\ud2bc \ud558\ub098\ubfd0\uc774\ub77c \ud14d\uc2a4\ud2b8 \uc804\uc6a9 \uacbd\ub85c\uac00 \ubb34\uac70\uc6cc\uc9c0\uc9c0 \uc54a\ub294\ub2e4 */\n.phdr{display:flex;align-items:center;gap:8px;margin-bottom:6px}\n.phdr .l{flex:none;font-weight:800;font-size:9.5px;letter-spacing:.16em;text-transform:uppercase;opacity:.55}\n.phdr .r{flex:1;height:2px;background:var(--ink);opacity:.16}   /* \ube0c\ub79c\ub4dc \ub8f0 \u2014 2px ink */\n.polled{display:flex;flex-direction:column;gap:6px}\n.polled .prow{display:flex;gap:6px;align-items:center}\n.polled .prow .inp{flex:1;min-width:0}\n.polled .prm{flex:none;min-width:44px;padding:9px 10px}\n.pwarn{display:none;font-weight:800;font-size:10px;letter-spacing:.1em;text-transform:uppercase;color:var(--red)}\n.pwarn.on{display:block}\n\n.empty{text-align:center;padding:52px 16px;opacity:.45;font-size:13.5px}\n.fab{position:absolute;right:20px;bottom:20px;width:56px;height:56px;border:none;background:var(--red);color:#fff;font-size:30px;line-height:1;cursor:pointer;z-index:40;\n  box-shadow:0 12px 26px rgba(174,24,0,.4);transition:transform .18s ease,box-shadow .18s ease}\n.fab:hover{transform:translateY(-2px) scale(1.05);box-shadow:0 16px 30px rgba(174,24,0,.5)}\n.fab:active{transform:scale(.95)}\n.stat{padding:9px 18px;border-top:1.5px solid var(--line);display:flex;gap:16px;font-weight:800;font-size:9.5px;letter-spacing:.14em;text-transform:uppercase;opacity:.5;background:var(--paper)}\n.stat i{font-style:normal;color:var(--red-700)}\n\n/* \u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550 \uc791\uc131 \u2014 \uc778\uc2a4\ud0c0\ud615 3\ub2e8 (\uc120\ud0dd \u2192 \ud3b8\uc9d1 \u2192 \uacf5\uc720) \u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\n   C3 \ud544\uc218\uc870\uac74: 1\ub2e8\uacc4 \ucd5c\uc0c1\ub2e8\uc5d0 \"Write without a photo\". \ud14d\uc2a4\ud2b8 \uc804\uc6a9\uc774 \ud604\uc7ac \uc8fc \uc6a9\ub3c4\ub77c\n   \uadf8\uac8c \uc5c6\uc73c\uba74 \ubbf8\ub514\uc5b4 \uc6b0\uc120 \ud750\ub984\uc774 \uc8fc \uc0ac\uc6a9\uc790\ub97c \ubc00\uc5b4\ub0b8\ub2e4. */\n#compose{position:absolute;inset:0;z-index:200;background:var(--paper);display:none;flex-direction:column}\n#compose.on{display:flex}\n.cbar{display:flex;align-items:center;gap:10px;padding:12px 16px;border-bottom:2px solid var(--ink);flex:none}\n.cbar .t{font-weight:900;font-size:15px;letter-spacing:-.01em;text-transform:uppercase}\n.cbar .steps{display:flex;gap:5px;margin-left:10px}\n.cbar .dot{width:22px;height:3px;background:var(--ink);opacity:.18}\n.cbar .dot.on{opacity:1;background:var(--red)}\n.cbar .sp{flex:1}\n.cbtn{border:1.5px solid var(--ink);background:transparent;padding:9px 15px;font-weight:800;font-size:11px;letter-spacing:.12em;text-transform:uppercase;cursor:pointer;color:var(--ink);min-height:40px}\n.cbtn:hover{background:var(--ink);color:var(--paper)}\n.cbtn.primary{background:var(--red);border-color:var(--red);color:#fff}\n.cbtn.primary:hover{background:var(--red-700);border-color:var(--red-700)}\n.cbtn:disabled{opacity:.35;cursor:not-allowed}\n.cbtn.ghost{border-color:var(--line)}\n.cbody{flex:1;overflow:auto;padding:16px}\n\n/* 1\ub2e8 \u2014 \ubbf8\ub514\uc5b4 \uc120\ud0dd */\n.nophoto{width:100%;border:2px solid var(--ink);background:var(--ink);color:var(--paper);padding:18px;\n  font-weight:900;font-size:15px;letter-spacing:.04em;text-transform:uppercase;cursor:pointer;display:flex;align-items:center;gap:12px;min-height:56px}\n.nophoto:hover{background:var(--red);border-color:var(--red)}\n.nophoto small{display:block;font-weight:600;font-size:10.5px;letter-spacing:.1em;opacity:.72;margin-top:3px;text-transform:none}\n.pickhead{display:flex;align-items:baseline;gap:10px;margin:20px 0 10px}\n.pickhead .l{font-weight:800;font-size:10px;letter-spacing:.18em;text-transform:uppercase;color:var(--red-700)}\n.pickhead .r{flex:1;height:2px;background:var(--ink);opacity:.16}\n/* \ucd5c\uc18c\ud3ed\uc774 2px \ucee4\uc11c \uceec\ub7fc\uc774 \ud558\ub098 \uc8fd\uc5c8\ub2e4 \u2014 \uadf8\ub9ac\ub4dc \ud53c\uce58 \uc0b0\uc218(AGENTS \u00a73)\uc640 \uac19\uc740 \ud568\uc815.\n   390px \uc5d0\uc11c cbody \uc548\ud3ed 322px. 104px \uc774\uba74 3\uceec\ub7fc\uc5d0 324px \uc774 \ud544\uc694\ud574 2\uceec\ub7fc(158px)\uc73c\ub85c \ub5a8\uc5b4\uc9c0\uace0\n   \uc378\ub124\uc77c 9\uc7a5\uc774 5\ud589 814px \uc774 \ub418\uc5b4 1\ub2e8\uacc4\uac00 274px \uc138\ub85c \uc2a4\ud06c\ub864\ub410\ub2e4. 96px \uc774\uba74 3\uceec\ub7fc(103px)\uc774 \ub4e4\uc5b4\uac04\ub2e4.\n   (\uc2e4\uce21 2026-08-08: 104px \u2192 scrollH 1002/clientH 728 \u00b7 96px \u2192 604/728 \uc2a4\ud06c\ub864 0) */\n.gal{display:grid;grid-template-columns:repeat(auto-fill,minmax(96px,1fr));gap:6px}\n.gal button{border:1.5px solid var(--line);background:var(--surface);padding:0;cursor:pointer;aspect-ratio:1;overflow:hidden;position:relative;min-height:44px}\n.gal button:hover{border-color:var(--ink)}\n.gal button.sel{border-color:var(--red);border-width:3px}\n.gal img{width:100%;height:100%;object-fit:cover;display:block}\n.gal .up{display:flex;align-items:center;justify-content:center;font-weight:800;font-size:26px;color:var(--ink);opacity:.5;height:100%}\n\n/* 2\ub2e8 \u2014 \ud3b8\uc9d1 */\n.edwrap{display:flex;flex-direction:column;gap:12px}\n.stage{position:relative;background:var(--ink);overflow:hidden;align-self:center;width:100%;max-width:460px;touch-action:none}\n.stage img{width:100%;height:100%;object-fit:cover;display:block;pointer-events:none}\n.stage.r1{aspect-ratio:1/1}.stage.r45{aspect-ratio:4/5}.stage.rfree{aspect-ratio:auto}\n.tlayer{position:absolute;inset:0}\n.tl{position:absolute;transform:translate(-50%,-50%);font-weight:900;font-size:26px;line-height:1.1;color:#fff;\n  text-shadow:0 2px 10px rgba(0,0,0,.55);cursor:grab;user-select:none;white-space:pre;padding:4px;touch-action:none}\n.tl.sel{outline:2px dashed rgba(255,255,255,.85);outline-offset:2px}\n.tl.drag{cursor:grabbing}\n.tin{position:absolute;transform:translate(-50%,-50%);z-index:5;background:rgba(32,30,29,.9);border:2px solid var(--red);\n  color:#fff;font-family:inherit;font-weight:900;font-size:20px;padding:7px 9px;min-width:150px;outline:none;text-align:center}\n/* \u2550\u2550\u2550 \uafb8\ubbf8\uae30 \u2014 \ub3c4\uad6c \ud0ed \u2550\u2550\u2550\n   \ud544\ud130\u00b7\uae00\uc790\u00b7\uc2a4\ud2f0\ucee4\u00b7\uadf8\ub9ac\uae30\u00b7\ud504\ub808\uc784\uc744 \ud0ed\uc73c\ub85c \ub098\ub208\ub2e4. \ub3c4\uad6c\uac00 \ub298\uc5b4\ub3c4 \ud234\ubc14\uac00 \ud55c \uc904\ub85c \uc720\uc9c0\ub41c\ub2e4(\ud050 3b \ub3d9\uc2dc \ud574\uacb0).\n   \ubaa8\ub4e0 \uafb8\ubbf8\uae30\ub294 **\ub808\uc774\uc5b4 \ub370\uc774\ud130**\ub85c \uc800\uc7a5\ud55c\ub2e4 \u2014 \uce94\ubc84\uc2a4\uc5d0 \uad7d\uc9c0 \uc54a\uc73c\ubbc0\ub85c \ub098\uc911\uc5d0 \uace0\uce60 \uc218 \uc788\uace0 \uae00\uc790\ub294 \uc2ec\uc0ac\uac00 \uac00\ub2a5\ud558\ub2e4. */\n.tabs2{display:flex;border:1.5px solid var(--ink);overflow:hidden}\n.tabs2 button{flex:1;border:none;background:transparent;padding:11px 6px;font-weight:800;font-size:10px;letter-spacing:.1em;text-transform:uppercase;cursor:pointer;color:var(--ink);min-height:44px}\n.tabs2 button+button{border-left:1.5px solid var(--ink)}\n.tabs2 button.on{background:var(--ink);color:var(--paper)}\n.panel{min-height:96px}\n.stk{display:grid;grid-template-columns:repeat(auto-fill,minmax(46px,1fr));gap:5px}\n.stk button{border:1.5px solid var(--line);background:var(--paper);font-size:23px;line-height:1;cursor:pointer;aspect-ratio:1;min-height:46px;padding:0}\n.stk button:hover{border-color:var(--red);background:#fff}\n.fonts{display:flex;gap:6px;overflow-x:auto;padding-bottom:3px}\n.fonts button{flex:none;border:1.5px solid var(--line);background:var(--paper);padding:9px 13px;font-size:16px;cursor:pointer;color:var(--ink);min-height:46px;white-space:nowrap}\n.fonts button.on{border-color:var(--red);border-width:2.5px}\n.stampgrid{display:grid;grid-template-columns:repeat(auto-fill,minmax(84px,1fr));gap:6px}\n.stampgrid button{border:1.5px solid var(--line);background:var(--paper);cursor:pointer;padding:7px;min-height:70px;display:grid;place-items:center}\n.stampgrid button:hover{border-color:var(--red)}\n.stampgrid svg{width:100%;height:auto;max-height:56px}\n.frames{display:flex;gap:6px;flex-wrap:wrap}\n.frames button{border:1.5px solid var(--line);background:var(--paper);padding:10px 13px;font-weight:800;font-size:10px;letter-spacing:.08em;text-transform:uppercase;cursor:pointer;color:var(--ink);min-height:44px}\n.frames button.on{background:var(--ink);color:var(--paper);border-color:var(--ink)}\n.widths{display:flex;gap:5px}\n.widths button{border:1.5px solid var(--line);background:var(--paper);width:46px;min-height:46px;cursor:pointer;display:grid;place-items:center;padding:0}\n.widths button.on{border-color:var(--red);border-width:2.5px}\n.widths i{display:block;background:var(--ink);border-radius:99px}\n\n/* \uc2a4\ud14c\uc774\uc9c0 \ub808\uc774\uc5b4 */\n.stage.f-polaroid{padding:14px 14px 52px;background:#fff}\n.stage.f-ink{padding:0;box-shadow:inset 0 0 0 3px var(--ink)}\n.stage.f-red{padding:0;box-shadow:inset 0 0 0 4px var(--red)}\n.stage.f-none{padding:0}\n.stage .inner{position:relative;width:100%;height:100%;overflow:hidden}\n.pen{position:absolute;inset:0;pointer-events:none}\n.pen.live{pointer-events:auto;touch-action:none;cursor:crosshair}\n.lay{position:absolute;transform-origin:center;user-select:none;touch-action:none;cursor:grab}\n.lay.sel{outline:2px dashed rgba(255,255,255,.9);outline-offset:3px}\n.lay.st{font-size:44px;line-height:1}\n.lay.tx{font-weight:900;font-size:26px;line-height:1.15;text-shadow:0 2px 10px rgba(0,0,0,.5);white-space:pre;padding:3px 6px}\n.lay.tx.bg-white{background:#fff;color:var(--ink)!important;text-shadow:none}\n.lay.tx.bg-red{background:var(--red);color:#fff!important;text-shadow:none}\n.lay.stamp svg{display:block;width:120px;height:auto}\n.hnd{position:absolute;right:-13px;bottom:-13px;width:26px;height:26px;background:var(--red);border:2px solid #fff;cursor:nwse-resize;display:none}\n.lay.sel .hnd{display:block}\n.filts{display:flex;gap:7px;overflow-x:auto;padding-bottom:4px;-webkit-overflow-scrolling:touch}\n.filts button{flex:none;border:1.5px solid var(--line);background:transparent;padding:0;cursor:pointer;width:66px}\n.filts button.on{border-color:var(--red);border-width:2.5px}\n.filts canvas{display:block;width:100%;aspect-ratio:1;object-fit:cover}\n.filts .nm{display:block;font-weight:800;font-size:8.5px;letter-spacing:.08em;text-transform:uppercase;padding:4px 2px;text-align:center;background:var(--paper)}\n.filts button.on .nm{background:var(--red);color:#fff}\n.row{display:flex;gap:7px;align-items:center;flex-wrap:wrap}\n.row .lbl{font-weight:800;font-size:9.5px;letter-spacing:.16em;text-transform:uppercase;opacity:.5;margin-right:2px}\n.tool{border:1.5px solid var(--line);background:transparent;padding:9px 12px;font-weight:800;font-size:10.5px;letter-spacing:.08em;text-transform:uppercase;cursor:pointer;color:var(--ink);min-height:40px}\n.tool:hover{border-color:var(--ink)}\n.tool.on{background:var(--ink);color:var(--paper);border-color:var(--ink)}\n.swatches{display:flex;gap:5px}\n.sw{width:26px;height:26px;border:2px solid #fff;box-shadow:0 0 0 1px var(--line);cursor:pointer;padding:0}\n.sw.on{box-shadow:0 0 0 2px var(--ink)}\n.hint{font-size:11.5px;line-height:1.55;opacity:.55}\n\n/* 3\ub2e8 \u2014 \uacf5\uc720 */\n.share{display:flex;flex-direction:column;gap:14px;max-width:520px;margin:0 auto}\n.sharetop{display:flex;gap:12px;align-items:flex-start}\n.sharetop .thumb{width:86px;height:86px;flex:none;border:1.5px solid var(--line);background:var(--surface);overflow:hidden;position:relative}\n.sharetop .thumb img{width:100%;height:100%;object-fit:cover;display:block}\n.sharetop .cap{flex:1}\n.fld{display:block;font-weight:800;font-size:9.5px;letter-spacing:.16em;text-transform:uppercase;opacity:.55;margin:0 0 5px}\n.inp,.sel,.ta{width:100%;border:1.5px solid var(--line);background:#fff;padding:11px;font-family:inherit;font-size:15px;color:var(--ink)}\n.inp:focus,.sel:focus,.ta:focus{outline:none;border-color:var(--red);box-shadow:0 0 0 3px rgba(236,48,19,.13)}\n.ta{min-height:84px;resize:vertical;line-height:1.5}\n.tones{display:flex;gap:9px}\n.tone{width:38px;height:38px;border:2px solid transparent;box-shadow:0 0 0 1px var(--line);cursor:pointer;padding:0}\n.tone.on{border-color:var(--ink)}\n.gate{display:flex;gap:9px;font-size:11.5px;line-height:1.55;background:rgba(236,48,19,.06);padding:11px;opacity:.9}\n.gate svg{flex:none;width:15px;height:15px;stroke:var(--red);fill:none;stroke-width:2;margin-top:1px}\n\n@media (max-width:560px){\n  .cbar{padding:10px 12px;gap:7px}\n  .cbar .t{font-size:13px}\n  .cbody{padding:12px}\n  .sharetop{flex-direction:column}\n  .sharetop .thumb{width:100%;height:150px}\n  /* \ud14d\uc2a4\ud2b8 \uc804\uc6a9 \uc790\ub9ac\ud45c\uc2dc\uc790\ub294 \uc815\ubcf4\uac00 0\uc778\ub370 150px \uc744 \uba39\ub294\ub2e4 (\ud56d\ubaa9 7).\n     \uadf8 150px \ub54c\ubb38\uc5d0 \ud22c\ud45c \uc120\ud0dd\uc9c0 3\u00b74\uac1c\uc5d0\uc11c 3\ub2e8\uc774 26 / 78px \uc138\ub85c \uc2a4\ud06c\ub864\ub410\ub2e4 \u2014 106px \uc744 \ub3cc\ub824\uc8fc\uba74 \ub458 \ub2e4 0 \uc774 \ub41c\ub2e4.\n     **\uc5c6\uc560\uc9c0\ub294 \uc54a\ub294\ub2e4**: 3\ub2e8\uc740 \ubcf4\ub0b4\uae30 \uc9c1\uc804 \ud654\uba74\uc774\ub77c \"\uc0ac\uc9c4\uc774 \uc548 \ubd99\uc5c8\ub2e4\"\ub97c \ud655\uc778\ud560 \uc790\ub9ac\uac00 \ud544\uc694\ud558\ub2e4.\n     \uc0ac\uc9c4\uc774 \uc788\uc744 \ub54c\uc758 150px \ubbf8\ub9ac\ubcf4\uae30\ub294 \uc774 \ud654\uba74\uc758 \ubcf8\ub860\uc774\ubbc0\ub85c \uadf8\ub300\ub85c \ub454\ub2e4. */\n  .sharetop .thumb.none{height:44px}\n  .cbar .steps{display:none}          /* \uc881\uc740 \ud654\uba74\uc5d0\uc11c \uc9c4\ud589 \uc810\uc740 \uc81c\ubaa9\uc774 \uc6b0\uc120 */\n}\n\n/* \u2550\u2550\u2550 \ud130\uce58 \uae30\uae30 \u2014 \uc2e4\uce21\uc73c\ub85c \uc7a1\uc740 \ubbf8\ub2ec \ud0c0\uae43\ub9cc \ud0a4\uc6b4\ub2e4 \u2550\u2550\u2550\n   pointer:coarse \ub85c \ubd84\uae30\ud55c\ub2e4. max-width \ub85c \ud558\uba74 \ud070 \ud0dc\ube14\ub9bf\uc744 \ub193\uce58\uace0,\n   \ub370\uc2a4\ud06c\ud1b1\uae4c\uc9c0 \ud0a4\uc6b0\uba74 \uce74\ub4dc\uac00 \ubd88\ud544\uc694\ud558\uac8c \ucee4\uc9c4\ub2e4 (NN/g: \ud50c\ub7ab\ud3fc\ubcc4\ub85c \ucd5c\uc801\ud654).\n   2026-08-08 \uc2e4\uce21 \ubbf8\ub2ec: .act 23px \u00b7 .sw 26px \u00b7 .mini 27px \u00b7 .chip 30px \u00b7 #q 32px \u00b7 .x 32px \u00b7 .pin 40px \u00b7 .tool 40px */\n@media (pointer:coarse){\n  /* 44px \uc740 **\uc190\uac00\ub77d \ud45c\uc801\uc758 \ud06c\uae30**\uc9c0 \ub808\uc774\uc544\uc6c3 \ud3ed\uc774 \uc544\ub2c8\ub2e4 (\ud56d\ubaa9 7).\n     \uc2e4\uce21: `.act` \ub294 42.7~43.7 \u00d7 44 \ub85c **\ud3ed\ub9cc** \ubbf8\ub2ec\uc774\uc5c8\ub2e4 \u2014 \uc774\uc804 \uae30\ub85d\ub4e4\uc758 \"44px \ubbf8\ub2ec 0\uac1c\"\ub294 \ub192\uc774\ub9cc \ubcf8 \uac12\uc774\ub2e4.\n     `min-width:44px` \ub85c \ud0a4\uc6b0\uba74 dense \ubcf4\ub4dc 228px `.foot` \uc758 \uc5ec\uc720\uac00 6.9 \u2192 3.8px \ub85c \uc904\uc5b4\ub4e0\ub2e4.\n     \uadf8 \uc5ec\uc720\ub294 \uce74\ub4dc \ub192\uc774\ub97c \uc9c0\ud0a4\ub294 \ub9c8\uc9c0\ub9c9 \uc644\ucda9\uc774\ub2e4(\ub3c4\uc7a5\u00b7\uad6c\uc5ed\u00b7\ud22c\ud45c\uc5d0\uc11c `.foot` \uc5d0 \ubc84\ud2bc \ub123\uae30\ub97c \uc138 \ubc88 \uae30\uac01\ud55c \uc774\uc720).\n     \uadf8\ub798\uc11c **\uadf8\ub9b0 \ud3ed\uc740 \uadf8\ub300\ub85c \ub450\uace0 hit \uc601\uc5ed\ub9cc ::after \ub85c 44px \uae4c\uc9c0 \ub113\ud78c\ub2e4** \u2014\n     `.seg` \ub97c border\u2192outline \uc73c\ub85c \ubc14\uafd4 \ud14c\ub450\ub9ac\uac00 \ub192\uc774\ub97c \uc548 \uba39\uac8c \ud55c \uac83\uacfc \uac19\uc740 \uc218\ubc95\uc774\ub2e4.\n     ::after \ub294 \uc774\ubca4\ud2b8 \ub300\uc0c1\uc774 \ub418\uc9c0 \uc54a\uc73c\ubbc0\ub85c `closest(\".act\")` \ub4dc\ub798\uadf8 \uac00\ub4dc\ub3c4 \uadf8\ub300\ub85c \ub3d9\uc791\ud55c\ub2e4. */\n  .pc .act{min-height:44px;padding:11px 10px;font-size:10.5px;position:relative}\n  .pc .act::after{content:\"\";position:absolute;top:0;bottom:0;left:50%;width:44px;transform:translateX(-50%)}\n  .pc .foot{gap:2px}\n  .pc .popt,.pc .pclose{min-height:44px}   /* \ud22c\ud45c(\ud050 6) \u2014 \uc120\ud0dd\uc9c0\ub3c4 \uc190\uac00\ub77d\uc73c\ub85c \ub204\ub974\ub294 \ud45c\uc801\uc774\ub2e4 */\n  /* \ub313\uae00(\ud050 11). `.cmt` \ub294 `.foot` \ubc16\uc774\ub77c \uc5ec\uae30\uc11c \uadf8\ub0e5 \ud0a4\uc6cc\ub3c4 \uce74\ub4dc \ud3ed \uc5ec\uc720\ub97c \uae4e\uc9c0 \uc54a\ub294\ub2e4 \u2014\n     `.act` \ub97c `::after` \ub85c\ub9cc \ub113\ud600\uc57c \ud588\ub358 \uac83\uacfc \uc0ac\uc815\uc774 \ub2e4\ub974\ub2e4 */\n  .pc .cmore,.pc .cin,.pc .csend{min-height:44px}\n  /* \ubc18\uc751(\ud050 12) \u2014 `.rxw` \ub3c4 `.foot` **\ubc16**\uc774\ub77c \uadf8\ub0e5 \ud0a4\uc6b4\ub2e4. `.act` \ub97c `::after` \ub85c\ub9cc \ub113\ud600\uc57c \ud588\ub358 \uc0ac\uc815\uc774 \uc5c6\ub2e4.\n     `::after` \ub85c hit \ub9cc \ub113\ud788\ub294 \uc218\ubc95\uc740 **\uc5ec\uae30\uc11c \uc4f0\uba74 \uc548 \ub41c\ub2e4**: 44px \uc624\ubc84\ub808\uc774\uac00 \uc704\ub85c \ubed7\uc5b4\n     \ubc14\ub85c \uc704 `.foot` \uc758 `.act` hit \uc744 \uac00\ub85c\ucc48\ub2e4 \u2014 \ud56d\ubaa9 7 \uc774 \ubc88 44px \ubcf4\uc7a5\uc744 \uc870\uc6a9\ud788 \ub418\ub3cc\ub9b0\ub2e4 */\n  .pc .rxmore{min-height:44px;padding:0 4px}\n  .pc .pin{width:46px;height:46px;top:-13px;right:12px}\n  .chip{min-height:44px;padding:12px 13px}\n  .mini{min-height:44px;padding:12px 8px}\n  .seg button{min-height:44px}\n  .search input{min-height:46px}\n  .inp,.sel,.ta{min-height:46px}\n  .x{width:44px;height:44px}\n  .tool,.cbtn,.nophoto{min-height:46px}\n  .sw{width:44px;height:44px}\n  .tone{width:46px;height:46px}\n  .gal button{min-height:56px}\n  .filts button{width:76px}          /* \uc5c4\uc9c0\ub85c \uc2a4\ud2b8\ub9bd\uc744 \ub118\uae38 \ub54c \uc7a1\uae30 \uc27d\uac8c */\n  .tl{font-size:22px}                /* \uc881\uc740 \uc2a4\ud14c\uc774\uc9c0\uc5d0\uc11c \uae00\uc790\uac00 \ud654\uba74\uc744 \ub36e\uc9c0 \uc54a\uac8c */\n  .fab{width:60px;height:60px;right:16px;bottom:16px}\n}\n\n/* \u2550\u2550\u2550 \uc555\ucd95 \ud234\ubc14 \u2014 \uc881\uc740 \ud654\uba74 (\ud050 3b) \u2550\u2550\u2550\n   \uc2e4\uce21 \ubb38\uc81c: 375px \uc5d0\uc11c \ud234\ubc14\uac00 4\uc904 \u2248 340px \uc744 \uba39\uc5b4 \uce74\ub4dc\uac00 \uc811\ud798 \uc544\ub798\ub85c \ubc00\ub838\ub2e4.\n   \ubdf0 \uc138\uadf8\uba3c\ud2b8\ub9cc \uc0c1\uc2dc \ub178\ucd9c\ud558\uace0 \ub098\uba38\uc9c0\ub97c \uc811\ub294\ub2e4 \u2014\n     \u2460 \ud544\ud130\uce69 \u2192 \ud55c \uc904 \uac00\ub85c \uc2a4\ud06c\ub864 (\uce69 \uc790\uccb4\ub294 \uacc4\uc18d \ubcf4\uc778\ub2e4. 4\uc904\u21921\uc904\uc758 \ub300\ubd80\ubd84\uc774 \uc5ec\uae30\uc11c \ub098\uc628\ub2e4)\n     \u2461 \ubc00\ub3c4\u00b7\uc815\ub82c\u00b7\uc815\ub9ac \u2192 `\u22ef` \ud31d\uc624\ubc84 (\ud558\ub8e8 1\ud68c \ubbf8\ub9cc \uc4f0\ub294 \uc635\uc158\uc774\ub77c \uc0c1\uc2dc \ub178\ucd9c \uac00\uce58\uac00 \ub0ae\ub2e4)\n     \u2462 \uac80\uc0c9 \u2192 \uc544\uc774\ucf58 \ud1a0\uae00. \ud3bc\uce60 \ub54c \ud234\ubc14 \uc704\uc5d0 **\uacb9\uccd0\uc11c** \uae50\ub2e4 \u2192 \ud234\ubc14 \ub192\uc774\uac00 \uc6d0\ub9ac\uc801\uc73c\ub85c \ubcc0\ud558\uc9c0 \uc54a\ub294\ub2e4\n   \uacbd\uacc4\uac00 \ub450 \uac1c\uc778 \uc774\uc720 (2026-08-09, \ud050 5 \uc5d0\uc11c \uc2e4\uce21\uc73c\ub85c \uac08\ub77c\uc84c\ub2e4)\n   \u00b7 `max-width:860px` \u2014 \ucc98\uc74c \uc815\ud55c \uacbd\uacc4. **\uc190\uac00\ub77d \uad75\uae30\uac00 \uc544\ub2c8\ub77c \ud3ed\ub9cc** \ubcf4\ub294 \uc870\uac74\uc774\ub2e4.\n   \u00b7 `(pointer:coarse) and (max-width:940px)` \u2014 \ud130\uce58 \uae30\uae30\ub294 `.chip`\u00b7`.mini` \ud328\ub529\uc774 \ucee4\uc838\n     \uac19\uc740 \ud3ed\uc5d0\uc11c\ub3c4 \ud234\ubc14\uac00 \ub354 \ub113\ub2e4. \uc2e4\uce21(\uac01 \uc870\uac01 \uace0\uc720\ud3ed \ud569\uc0b0): coarse \ud234\ubc14 \ud544\uc694\ud3ed **849.6px**,\n     \ubdf0\ud3ec\ud2b8\ub85c \ud658\uc0b0\ud558\uba74 **893.6px**(=849.6 + .wrap 40 + .app \ud14c\ub450\ub9ac 4). \uc989 **coarse 861~894px \uc5d0\uc11c 2\uc904\ub85c \ud130\uc9c4\ub2e4.**\n     \ud050 5 \uc758 `\uad6c\uc5ed` \ubc84\ud2bc\uc774 coarse \uc5d0\uc11c **70.8px** \uc744 \uba39\uc73c\uba74\uc11c(778.8 \u2192 849.6) \uc774 \uad6c\uac04\uc774 \uc0dd\uacbc\ub2e4.\n     940px \ub85c \uc7a1\uc73c\uba74 coarse 940 \uc5d0\uc11c \uc548\ud3ed 896 > 849.6 \uc774\ub77c 46px \uc5ec\uc720\uac00 \ub0a8\ub294\ub2e4.\n     fine(\ub9c8\uc6b0\uc2a4)\uc740 \ud544\uc694\ud3ed 801.6 \u2192 845.6px \uc774\ub77c 860 \uacbd\uacc4\uac00 \uc774\ubbf8 \ub36e\ub294\ub2e4 \u2014 \uadf8\ub798\uc11c fine \uc740 \uac74\ub4dc\ub9ac\uc9c0 \uc54a\ub294\ub2e4.\n   **\uc774 \ube14\ub85d\uc740 pointer:coarse \ube14\ub85d\ubcf4\ub2e4 \ub4a4\uc5d0 \uc788\uc5b4\uc57c \ud55c\ub2e4** \u2014 \uac19\uc740 \ud2b9\uc774\ub3c4\ub77c \uc21c\uc11c\ub85c \uc774\uae34\ub2e4\n   (.chip \ud328\ub529\uc744 coarse \uac12\uc5d0\uc11c \ub2e4\uc2dc \uc904\uc778\ub2e4). \uc704\ub85c \uc62e\uae30\uba74 \uc870\uc6a9\ud788 \ubb34\ud6a8\uac00 \ub41c\ub2e4. */\n@media (max-width:860px), (pointer:coarse) and (max-width:940px){\n  .tools{flex-wrap:nowrap;gap:6px;padding:5px 10px}\n  /* seg \ud14c\ub450\ub9ac\ub97c outline \uc73c\ub85c \ubc14\uafbc\ub2e4 \u2014 outline \uc740 \ub808\uc774\uc544\uc6c3 \ub192\uc774\ub97c \ucc28\uc9c0\ud558\uc9c0 \uc54a\uc73c\ubbc0\ub85c\n     \ubc84\ud2bc 44px \uc774 \uace7 seg 44px \uc774 \ub41c\ub2e4. border \ub85c \ub450\uba74 47px \uc774 \ub418\uc5b4 \ud234\ubc14\uac00 56px \uc744 \ub118\ub294\ub2e4.\n     outline-offset \uc74c\uc218\ub85c \uc548\ucabd\uc5d0 \uadf8\ub824 \ubcf4\uc774\ub294 \ubaa8\uc591\uc740 \ud5e4\uc5b4\ub77c\uc778 \uadf8\ub300\ub85c\ub2e4 */\n  .seg{flex:none;border:none;outline:1.5px solid var(--ink);outline-offset:-1.5px}\n  .seg button{padding:8px 11px}\n  .chips{flex:1 1 0;min-width:0;flex-wrap:nowrap;gap:5px;overflow-x:auto;overflow-y:hidden;\n    scrollbar-width:none;-webkit-overflow-scrolling:touch}\n  .chips::-webkit-scrollbar{display:none}   /* \uc2a4\ud06c\ub864\ubc14\uac00 44px \uc904 \uc548\uc5d0\uc11c \ub192\uc774\ub97c \uba39\ub294\ub2e4 */\n  /* \ub354 \uc2a4\ud06c\ub864\ud560 \uac8c \uc788\uc744 \ub54c\ub9cc \uc624\ub978\ucabd\uc744 \ud750\ub9b0\ub2e4. \ud56d\uc0c1 \uac78\uba74 \uc2a4\ud06c\ub864 \uc5c6\ub294 \ud3ed\uc5d0\uc11c \uba40\uca61\ud55c \uce69\uc744 \uae4e\ub294\ub2e4\n     (scrollable \ud074\ub798\uc2a4\ub294 render() \uac00 scrollWidth \ub85c \ud310\uc815\ud574 \ubd99\uc778\ub2e4) */\n  .chips.scrollable{-webkit-mask-image:linear-gradient(90deg,#000 calc(100% - 16px),transparent);\n                            mask-image:linear-gradient(90deg,#000 calc(100% - 16px),transparent)}\n  .chip{flex:none;padding:12px 11px}\n  .iconbtn{display:flex}\n  .tgrp{display:none;position:absolute;right:10px;top:calc(100% + 3px);z-index:60;\n    flex-direction:column;align-items:stretch;min-width:170px;\n    background:var(--paper);border:2px solid var(--ink);padding:4px}\n  .tools.moreon .tgrp{display:flex}\n  .tgrp .mini{text-align:left;padding:13px 11px;opacity:.85}\n  .tgrp .mini+.mini{border-top:1.5px solid var(--line-soft)}\n  .search{display:none}\n  .tools.searchon .search{display:flex;align-items:center;gap:6px;position:absolute;inset:0;\n    margin:0;padding:5px 10px;background:var(--paper);z-index:70}\n  .tools.searchon .search input{flex:1 1 auto;width:auto;min-width:0}\n  .tools.searchon .search svg{left:21px}   /* .search \uac00 \uc778\uc14b 0 \uc774 \ub418\uba74\uc11c \uae30\uc900\uc810\uc774 \uc62e\uaca8\uac04\ub2e4 */\n  /* .mini \ub294 \uc138\ub85c\ub9cc 44px \uc774\ub77c \u2715 \ub294 \ud3ed\uc774 25px \ubc16\uc5d0 \uc548 \ub410\ub2e4(\uc2e4\uce21) \u2014 \uac00\ub85c\ub3c4 44px \ub85c \ucc44\uc6b4\ub2e4 */\n  .tools.searchon #qclose{display:block;flex:none;min-width:44px;padding:12px 4px;text-align:center}\n}\n/* \uae30\uc6b8\uae30 \ud1a0\uae00. \uce74\ub4dc\ub9c8\ub2e4 --tilt \uac00 \uc778\ub77c\uc778\uc73c\ub85c \ubd99\uc5b4 \uc788\uc5b4\uc11c !important \uac00 \uc544\ub2c8\uba74 \ubabb \uc774\uae34\ub2e4.\n   \uae30\ubcf8\uac12\uc740 \uaebc\uc9d0 \u2014 \uc0ac\uc9c4\uc774 \ud070 \uc2e4\uc81c \ubcf4\ub4dc\uc5d0\uc11c\ub294 \uae30\uc6b8\uae30\uac00 \ubb3c\uc131\uc774 \uc544\ub2c8\ub77c \ud750\ud2b8\ub7ec\uc9d0\uc73c\ub85c \uc77d\ud78c\ub2e4. */\n/* \uae30\uc6b8\uae30 \uc5c6\uc74c. \uc2dc\uc548\uc5d0\uc11c\ub294 \ubb3c\uc131\uc774\uc5c8\uc9c0\ub9cc \uc2e4\uc81c \ubcf4\ub4dc\ub294 \uc0ac\uc9c4\uc774 \ud06c\uace0 \uc7a5\uc218\uac00 \ub9ce\uc544\n   \ud750\ud2b8\ub7ec\uc9d0\uc73c\ub85c \uc77d\ud614\ub2e4. --tilt \uac00 \uce74\ub4dc\ub9c8\ub2e4 \uc778\ub77c\uc778\uc774\ub77c !important \ub85c \ub20c\ub7ec\uc57c \uc774\uae34\ub2e4. */\n.pc{--tilt:0deg!important}\n.pc .att{transform:translateX(-50%)!important}\n/* \ubd84\uc2e4\ubb3c \u2014 \ucc3e\uc544\uac04 \uac83\uc740 \uc9c0\uc6b0\uc9c0 \uc54a\uace0 \ud750\ub9ac\uac8c \ub0a8\uae34\ub2e4. \"\uc774\ubbf8 \uc8fc\uc778\uc774 \uac00\uc838\uac14\ub2e4\"\ub294 \uc0ac\uc2e4\ub3c4 \uae30\ub85d\uc774\ub2e4 */\n.pc.claimedcard{opacity:.5}\n.pc.claimedcard .msg{text-decoration:line-through;text-decoration-thickness:1.5px}\n.pc .act.claim{color:var(--red-700)}\n/* \ud53c\ub4dc \ud55c \uceec\ub7fc \ud3ed\uc744 \ubb36\ub294\ub2e4. \ud310 \uc804\uccb4 \ud3ed(1025px)\uc73c\ub85c \ub298\uc5b4\ub098\uba74 \ud55c \uc904\uc774 150\uc790\ub97c \ub118\uc5b4\n   \ub208\uc774 \uc904\uc744 \ub193\uce5c\ub2e4. \uc778\uc2a4\ud0c0\uac00 \uc881\uc740 \uc138\ub85c\ub2e8\uc744 \uc4f0\ub294 \uc774\uc720\uc640 \uac19\ub2e4. */\n#feed.view-feed .cols{max-width:620px;margin-left:auto;margin-right:auto}\n/* \uc2e4\uc81c \ub85c\uace0 \ud30c\uc77c\uc744 \uc4f4\ub2e4. \uc2dc\uc548\uc758 \uc6d0 \uc544\uc774\ucf58\uc740 \uc790\ub9ac\ub97c \uc7a1\uc544 \ub450\ub824\uace0 \uadf8\ub9b0 \ubaa9\uc5c5\uc774\uc5c8\ub2e4. */\n.brandlogo{height:46px;width:auto;flex:none;display:block}\n@media (max-width:520px){.brandlogo{height:34px}}\n/* \ubd84\uc2e4\ubb3c \uc785\ub825 \u2014 \uc5b4\ub514\uc11c/\uc5b8\uc81c\ub294 \uc9e7\uc73c\ub2c8 \ud55c \uc904\uc5d0 \ub458 */\n.lrow{display:grid;grid-template-columns:1fr 1fr;gap:10px}\n@media (max-width:520px){.lrow{grid-template-columns:1fr}}\n/* \uce74\ub4dc \uc704 \ubd84\uc2e4\ubb3c \uc815\ubcf4 \u2014 \uba54\uc2dc\uc9c0\ubcf4\ub2e4 \uba3c\uc800 \uc77d\ud600\uc57c \ud55c\ub2e4 */\n.pc .lost{display:flex;flex-wrap:wrap;gap:6px 14px;margin-top:8px;font-weight:800;font-size:10px;\n  letter-spacing:.1em;text-transform:uppercase}\n.pc .lost b{color:var(--red-700);font-weight:800}\n.pc .lost span{opacity:.6;font-weight:600;letter-spacing:.04em;text-transform:none;font-size:12.5px}\n/* \uacf5\uc720 \ub2e8\uacc4\uc758 \uc0ac\uc9c4 \uc790\ub9ac \u2014 \ube44\uc5b4 \uc788\uc73c\uba74 \"\uc5c6\uc74c\"\uc774 \uc544\ub2c8\ub77c \"\ub123\uae30\" \ub2e4 */\n.sharetop .thumb{border:2px dashed var(--line);cursor:pointer;padding:0}\n.sharetop .thumb:hover{border-color:var(--red)}\n.sharetop .thumb .thadd{display:flex;flex-direction:column;align-items:center;justify-content:center;gap:3px;\n  height:100%;font-weight:800;font-size:9.5px;letter-spacing:.12em;text-transform:uppercase;opacity:.6}\n.sharetop .thumb .thadd b{font-size:24px;line-height:1;color:var(--red)}\n.thdrop{align-self:flex-start;margin-top:6px;border:none;background:transparent;cursor:pointer;\n  font-weight:800;font-size:9.5px;letter-spacing:.1em;text-transform:uppercase;opacity:.5;padding:6px 0}\n.thdrop:hover{opacity:1;color:var(--red)}\n/* \ubb34\uc7a5 \uc911\uc5d0\ub294 \ub3c4\uc7a5\uc774 \uc9c0\uc6b8 \uc218 \uc788\ub294 \uac83\uc774 \ub41c\ub2e4 */\nbody.stamping .rstmp{pointer-events:auto;cursor:pointer}\nbody.stamping .rstmp:hover{outline:2px solid var(--red);outline-offset:2px;opacity:.55}\n/* \ub3c4\uc7a5 \ubc84\ud2bc \u2014 \ub2e4\ub978 mini \uc640 \ub611\uac19\uc774 \uc0dd\uae30\uba74 \"\uc9c0\uae08 \ubb34\uc5c7\uc774 \ucc0d\ud788\ub294\uc9c0\" \ub97c \uc54c \uc218 \uc5c6\ub2e4.\n   \uace0\ub978 \ub3c4\uc7a5\uc758 \uc0c9\uc744 \uc810\uc73c\ub85c \ub2ec\uace0, \ubb34\uc7a5 \uc911\uc5d0\ub294 \ubc84\ud2bc \uc790\uccb4\uac00 \uadf8 \uc0c9\uc774 \ub41c\ub2e4. */\n.stampbtn{display:inline-flex;align-items:center;gap:7px;border:1.5px solid var(--line);padding:7px 12px}\n.stampbtn:hover{border-color:var(--ink);opacity:1}\n.stampbtn .sdot{width:11px;height:11px;border-radius:50%;background:var(--sc,var(--ink));\n  box-shadow:0 0 0 2px var(--paper),0 0 0 3.5px var(--sc,var(--ink))}\n.stampbtn.on{background:var(--sc,var(--red));border-color:var(--sc,var(--red));color:#fff}\n.stampbtn.on .sdot{background:#fff;box-shadow:0 0 0 2px var(--sc,var(--red)),0 0 0 3.5px #fff}\n/* \u2500\u2500 \uc791\uc131 1\ub2e8 \u2014 \ud310\uc5d0\uc11c \ub72f\uc5b4\uc628 \uac83\ucc98\ub7fc \u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\n   \uc804\uc5d0\ub294 \ud770 \ubc14\ud0d5\uc5d0 \ud14c\ub450\ub9ac \uc0c1\uc790 \ub137\uc774\ub77c, \ubc29\uae08 \ubcf4\ub358 \uac8c\uc2dc\ud310\uacfc \ub2e4\ub978 \ud654\uba74\ucc98\ub7fc \ubcf4\uc600\ub2e4.\n   \uac19\uc740 \uc885\uc774\u00b7\uac19\uc740 \uc789\ud06c \uc5b4\uae0b\ub0a8\u00b7\uac19\uc740 \uc555\uc815\uc744 \uc4f0\uba74 \"\uc774 \ud310\uc5d0 \ubd99\uc77c \uce74\ub4dc\ub97c \uace0\ub974\ub294 \uc911\"\uc73c\ub85c \uc77d\ud78c\ub2e4. */\n/* \uc791\uc131 \ud654\uba74\ub3c4 \ud310\uacfc \uac19\uc740 \ubc14\ud0d5\u00b7\uac19\uc740 \uaca9\uc790\ub97c \uc4f4\ub2e4 \u2014 \ub2e4\ub978 \ud654\uba74\uc73c\ub85c \ubcf4\uc774\uba74 \uc548 \ub41c\ub2e4 */\n/* \uc791\uc131 \ud654\uba74\ub3c4 \ud310\uacfc **\uac19\uc740 \uc885\uc774**\ub97c \uc4f4\ub2e4 \u2014 \uc0c9\uc774 \ub2e4\ub974\uba74 \ub2e4\ub978 \uc571\ucc98\ub7fc \ubcf4\uc778\ub2e4 */\n.cbody{background-color:#ddd5c6;\n  background-image:linear-gradient(var(--grid) 1px,transparent 1px),linear-gradient(90deg,var(--grid) 1px,transparent 1px);\n  background-size:22px 22px,22px 22px}\n/* 2\u00d72. \ub137\uc744 \ud55c \uc904\ub85c \ub298\uc5b4\ub193\uc73c\uba74 \uce74\ub4dc\uac00 \ub0a9\uc791\ud574\uc838 \uc544\uc774\ucf58\ub3c4 \uae00\uc790\ub3c4 \uc791\uc544\uc9c0\uace0,\n   \ub208\uc774 \uc88c\uc6b0\ub85c\ub9cc \ud6d1\uc5b4\uc11c \"\ub124 \uac08\ub798\"\uac00 \ud55c \ub369\uc5b4\ub9ac\ub85c \uc548 \uc77d\ud78c\ub2e4. */\n.pick2{display:grid;grid-template-columns:repeat(2,1fr);gap:20px;margin:26px 0 8px;max-width:760px}\n.pk{position:relative;display:flex;flex-direction:column;align-items:center;justify-content:center;\n  gap:9px;min-height:250px;padding:26px 16px 22px;cursor:pointer;text-align:center;\n  background:var(--paper);border:1.5px solid var(--line);color:var(--ink);font-family:inherit;\n  transition:border-color .18s ease,transform .18s cubic-bezier(.2,.9,.3,1.14)}\n/* \uc789\ud06c \ub4f1\ub85d \uc624\ucc28 \u2014 \uce74\ub4dc\uc640 \uac19\uc740 \uaddc\uce59 */\n.pk::after{content:'';position:absolute;inset:-1.5px;border:1.5px solid var(--red);\n  mix-blend-mode:multiply;opacity:.34;pointer-events:none;transition:opacity .18s ease}\n/* \uc555\uc815 \u2014 \ud310\uc5d0 \uaf42\ud78c \uce74\ub4dc\uc640 \uac19\uc740 \ub0a9\uc791\ud55c \ub9ac\uc18c \uc6d0 */\n.pk::before{content:'';position:absolute;left:50%;top:-8px;width:15px;height:15px;border-radius:50%;\n  background:var(--red);mix-blend-mode:multiply;transform:translateX(-50%);\n  box-shadow:0 0 0 3px rgba(236,48,19,.18);z-index:2}\n.pk:hover{border-color:var(--ink);transform:translateY(-3px)}\n.pk:hover::after{opacity:.62}\n/* \uc544\uc774\ucf58\uc774 \uba3c\uc800 \ub208\uc5d0 \ub4e4\uc5b4\uc640\uc57c \ub124 \uac08\ub798\uac00 \ud55c\ub208\uc5d0 \uac08\ub9b0\ub2e4 \u2014 \uae00\uc790\ub97c \uc77d\uae30 \uc804\uc5d0 \ubaa8\uc591\uc73c\ub85c \uad6c\ubd84\ub41c\ub2e4 */\n.pk .pkic{font-size:62px;line-height:1;color:var(--red);opacity:.92;margin-bottom:4px}\n.pk .pkt{font-weight:900;font-size:24px;letter-spacing:-.015em;text-transform:uppercase;line-height:1.02}\n.pk .pks{font-weight:600;font-size:13.5px;letter-spacing:.01em;opacity:.55;text-transform:none;line-height:1.45;max-width:22ch}\n.pk.lostpk .pkic{color:var(--fortress)}\n.pk.pollpk .pkic{color:var(--sanctuary)}\n/* \uc885\uc774 \uacb0\ub3c4 \uce74\ub4dc\uc640 \uac19\uac8c \u2014 \ub137\uc774 \uc804\ubd80 \uac19\uc740 \uc885\uc774\uba74 \ub2e4\uc2dc \ubc0b\ubc0b\ud574\uc9c4\ub2e4 */\n.pk:nth-child(2){background-image:repeating-linear-gradient(transparent 0 25px,color-mix(in srgb,var(--ink) 7%,transparent) 25px 26px);background-position:0 12px}\n.pk:nth-child(4){background-image:repeating-linear-gradient(transparent 0 21px,color-mix(in srgb,var(--ink) 5%,transparent) 21px 22px),repeating-linear-gradient(90deg,transparent 0 21px,color-mix(in srgb,var(--ink) 5%,transparent) 21px 22px)}\n/* \ubb34\uc5c7\uc744 \uace0\ub974\ub294 \uc911\uc778\uc9c0 \uc54c\ub824\uc8fc\ub294 \uba38\ub9ac\ub9d0 \u2014 \uc2dc\uc548\uc758 \uad6c\uc5ed \ub77c\ubca8\uacfc \uac19\uc740 \uc789\ud06c \uadf8\ub9bc\uc790 */\n.pickttl{position:relative;isolation:isolate;display:inline-block;margin:2px 0 0;\n  font-weight:800;font-size:11px;letter-spacing:.18em;text-transform:uppercase;color:var(--ink)}\n.pickttl::before{content:attr(data-t);position:absolute;left:2px;top:1.5px;color:var(--red);\n  mix-blend-mode:multiply;opacity:.7;z-index:-1;white-space:nowrap;pointer-events:none}\n@media (max-width:1000px){.pick2{grid-template-columns:1fr 1fr;gap:16px}}\n@media (max-width:760px){.pk{min-height:200px}.pk .pkic{font-size:52px}.pk .pkt{font-size:21px}}\n@media (max-width:520px){.pick2{grid-template-columns:1fr;gap:14px}\n  /* \ud55c \uc904\uc5d0 \ud558\ub098\uba74 \uc138\ub85c\ub85c \uae38 \ud544\uc694\uac00 \uc5c6\ub2e4 \u2014 \uc544\uc774\ucf58\uc744 \uc67c\ucabd\uc5d0 \ub450\uace0 \ub192\uc774\ub97c \uc904\uc778\ub2e4 */\n  .pk{min-height:104px;flex-direction:row;align-items:center;text-align:left;gap:16px;padding:16px 18px}\n  .pk .pkic{font-size:38px;margin:0}\n  .pk .pkt{font-size:19px}\n  .pk .pks{font-size:12.5px;max-width:none}}\n/* \ubc14\ub85c \ucc0d\uae30 \u2014 \uce74\uba54\ub77c\uac00 \uc788\ub294 \uae30\uae30\uc5d0\uc11c\ub9cc \ubcf4\uc778\ub2e4. \ub370\uc2a4\ud06c\ud1b1\uc5d0\uc11c\ub294 \ub204\ub97c \uc218 \uc5c6\ub294 \ubc84\ud2bc\uc774 \ub298 \ubfd0\uc774\ub2e4. */\n.thcam{align-self:flex-start;margin-top:6px;border:1.5px solid var(--ink);background:transparent;color:var(--ink);\n  cursor:pointer;font-weight:800;font-size:9.5px;letter-spacing:.1em;text-transform:uppercase;padding:9px 11px;min-height:44px}\n.thcam:hover{background:var(--ink);color:var(--paper)}\n@media (hover:hover) and (pointer:fine){.thcam{display:none}}\n</style>\n</head>\n<body>\n<div class=\"wrap\"><div class=\"app\" style=\"position:relative\">\n\n  <div class=\"head\">\n    <!-- \uc2e4\uc81c \ub85c\uace0 \ud30c\uc77c. \ubc30\ud3ec \uc2dc index.html\u00b7postcards.js \uc640 \uac19\uc740 \ub8e8\ud2b8\uc5d0 \uc62c\ub77c\uac04\ub2e4 -->\n    <img class=\"brandlogo\" src=\"/hideout-logo.png\" alt=\"The Hideout\"\n         onerror=\"this.style.display='none'\">\n    <span class=\"mark\">\n      <span class=\"n\">POSTCARDS</span>\n      <span class=\"s\">The Hideout \u00b7 Staff Board</span>\n    </span>\n    <button class=\"x\">\u00d7</button>\n  </div>\n\n  <div class=\"ribbon\"><div class=\"marq\"><span>SAY SOMETHING KIND<b>\u00b7</b>COFFEE FIRST<b>\u00b7</b>THE HIDEOUT PEOPLE<b>\u00b7</b>SAY SOMETHING KIND<b>\u00b7</b>COFFEE FIRST<b>\u00b7</b>THE HIDEOUT PEOPLE<b>\u00b7</b></span><span>SAY SOMETHING KIND<b>\u00b7</b>COFFEE FIRST<b>\u00b7</b>THE HIDEOUT PEOPLE<b>\u00b7</b>SAY SOMETHING KIND<b>\u00b7</b>COFFEE FIRST<b>\u00b7</b>THE HIDEOUT PEOPLE<b>\u00b7</b></span></div></div>\n\n  <div class=\"tools\">\n    <span class=\"seg\" id=\"view\"><button data-v=\"board\" class=\"on\">Pinboard</button><button data-v=\"feed\">Feed</button><button data-v=\"lost\">Lost &amp; found</button></span>\n    <!-- \ub370\uc2a4\ud06c\ud1b1\uc5d0\uc120 .tgrp \uac00 display:contents \ub77c \uc544\ub798 3\uac1c\uac00 \ud234\ubc14\uc5d0 \uadf8\ub300\ub85c \ubd99\ub294\ub2e4.\n         \uc881\uc740 \ud654\uba74\uc5d0\uc11c\ub9cc \uc774 \ub798\ud37c\uac00 `\u22ef` \ud31d\uc624\ubc84\ub85c \ubc14\ub010\ub2e4 -->\n    <span class=\"tgrp\" id=\"tgrp\">\n      <button class=\"mini stampbtn\" id=\"stamp\"><span class=\"sdot\"></span><span class=\"slbl\">Stamp</span></button>\n      \n    </span>\n    <button class=\"iconbtn\" id=\"searchtog\" aria-label=\"Search\" aria-expanded=\"false\">\n      <svg viewBox=\"0 0 24 24\" fill=\"none\" stroke=\"currentColor\" stroke-width=\"2\"><circle cx=\"11\" cy=\"11\" r=\"7\"/><path d=\"M20 20l-4-4\"/></svg>\n    </button>\n    <button class=\"iconbtn\" id=\"more\" aria-label=\"More options\" aria-expanded=\"false\">\n      <svg viewBox=\"0 0 24 24\" fill=\"currentColor\"><rect x=\"3\" y=\"10.5\" width=\"3.5\" height=\"3.5\"/><rect x=\"10.25\" y=\"10.5\" width=\"3.5\" height=\"3.5\"/><rect x=\"17.5\" y=\"10.5\" width=\"3.5\" height=\"3.5\"/></svg>\n    </button>\n    <span class=\"search\">\n      <svg viewBox=\"0 0 24 24\"><circle cx=\"11\" cy=\"11\" r=\"7\"/><path d=\"M20 20l-4-4\"/></svg>\n      <input id=\"q\" placeholder=\"Search\" autocomplete=\"off\"/>\n      <button class=\"mini\" id=\"qclose\" aria-label=\"Close search\">\u2715</button>\n    </span>\n  </div>\n\n  <div class=\"body\" id=\"body\"><div id=\"feed\" class=\"view-board\"><div id=\"ghost\"></div></div></div>\n\n  <!-- \u2550\u2550\u2550 \ub3c4\uc7a5 \ud2b8\ub808\uc774 (\ud050 4) \u2014 \ud750\ub984 \uc548\uc5d0 \ub123\uc5b4 body \ub97c \uc904\uc778\ub2e4. \uacb9\uce58\uba74 \ub9e8 \uc544\ub798 \uce74\ub4dc\uac00 \uac00\ub824\uc9c4\ub2e4 \u2550\u2550\u2550 -->\n  <div class=\"stray\" id=\"stray\">\n    <span class=\"l2\">Stamps</span>\n    <div class=\"spick\" id=\"spick\"></div>\n    <button class=\"sbtn\" id=\"sundo\" aria-label=\"Undo last stamp\" title=\"Undo\" disabled>\u21ba</button>\n    <button class=\"sbtn go\" id=\"sdone\">Done</button>\n  </div>\n\n  <div class=\"stat\">\n    <span>Showing <i id=\"s-n\">0</i></span>\n    <span>Overlap <i id=\"s-hit\">0</i></span>\n    <span id=\"s-mode\">Feed \u00b7 masonry</span>\n  </div>\n\n  <button class=\"fab\" id=\"fab\" title=\"New postcard\">+</button>\n\n  <!-- \u2550\u2550\u2550 \uc791\uc131 \u2014 \uc778\uc2a4\ud0c0\ud615 3\ub2e8 \u2550\u2550\u2550 -->\n  <div id=\"compose\">\n    <div class=\"cbar\">\n      <button class=\"cbtn ghost\" id=\"cback\">\u2190</button>\n      <span class=\"t\" id=\"ctitle\">New postcard</span>\n      <span class=\"steps\"><i class=\"dot on\"></i><i class=\"dot\"></i><i class=\"dot\"></i></span>\n      <span class=\"sp\"></span>\n      <button class=\"cbtn\" id=\"cclose\">Close</button>\n      <button class=\"cbtn primary\" id=\"cnext\">Next</button>\n    </div>\n    <div class=\"cbody\" id=\"cbody\"></div>\n  </div>\n</div></div>\n\n<!-- \uc789\ud06c \ubc88\uc9d0 \u2014 \ud14c\ub450\ub9ac\uc640 \uae00\uc790\ub97c \ub178\uc774\uc988\ub85c \uc0b4\uc9dd \ubc00\uc5b4 \uace0\ubb34\ub3c4\uc7a5\uc758 \ubd88\uade0\uc77c\ud55c \uc790\uad6d\uc744 \ub9cc\ub4e0\ub2e4.\n     \uc0ac\uc9c4(\ub798\uc2a4\ud130)\uc774 \uc544\ub2c8\ub77c \ud544\ud130\ub77c\uc11c \uc5b4\ub5a4 \uc0c9\u00b7\uae00\uc790 \uae38\uc774\uc5d0\ub3c4 \uac19\uc774 \ub530\ub77c\uac04\ub2e4 -->\n<svg width=\"0\" height=\"0\" style=\"position:absolute\" aria-hidden=\"true\" focusable=\"false\">\n  <filter id=\"inkedge\" x=\"-15%\" y=\"-25%\" width=\"130%\" height=\"150%\">\n    <feTurbulence type=\"fractalNoise\" baseFrequency=\"0.85\" numOctaves=\"2\" seed=\"7\" result=\"n\"/>\n    <feDisplacementMap in=\"SourceGraphic\" in2=\"n\" scale=\"2.4\" xChannelSelector=\"R\" yChannelSelector=\"G\"/>\n  </filter>\n</svg>\n\n<svg width=\"0\" height=\"0\" style=\"position:absolute\" aria-hidden=\"true\" focusable=\"false\">\n  <filter id=\"inkedge\" x=\"-15%\" y=\"-25%\" width=\"130%\" height=\"150%\">\n    <feTurbulence type=\"fractalNoise\" baseFrequency=\"0.85\" numOctaves=\"2\" seed=\"7\" result=\"n\"/>\n    <feDisplacementMap in=\"SourceGraphic\" in2=\"n\" scale=\"2.4\" xChannelSelector=\"R\" yChannelSelector=\"G\"/>\n  </filter>\n</svg>";
